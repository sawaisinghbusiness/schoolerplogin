  ...
  return (
    <div className="space-y-5 animate-fadeIn pb-16 text-xs text-slate-800">
      ...
      <div className="pb-3 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          <div className="flex items-center space-x-1.5 text-slate-500 mb-1 text-xs">
        ...
        <div className="flex items-center space-x-2">
          <Link
            ...
            className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-semibold border border-slate-300 transition-colors flex items-center space-x-1 text-xs"
          >
          ...
          <Link
            href="/syllabus-file"
            className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold shadow-xs transition-colors flex items-center space-x-1 text-xs"
          >
      ...
      <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-xs space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-slate-400 text-xs font-mono">Session: 2026-2027</span>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <span className="font-black text-sm text-emerald-600 w-12 text-right">
                    {percent}%
                  </span>
                ...
                <div className="border-t border-slate-200 bg-slate-50/50 p-4 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5">
                    {sub.chapters.map((ch) => (
                      <div
                        key={ch.no}
                        className="bg-white p-3 rounded-lg border border-slate-200 flex items-start justify-between space-x-2"
                      >
                        <div>
