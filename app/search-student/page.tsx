      ...
      <div className="bg-white rounded-xl shadow-xs border border-slate-200/80 overflow-hidden">
        <form onSubmit={handleSearchSubmit} className="p-4 sm:p-5 space-y-3">
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-2 sm:gap-3">
            ...
            <div className="relative min-w-[190px]">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-slate-50/70 hover:bg-slate-100/70 border border-slate-300 text-slate-800 font-semibold text-xs sm:text-sm rounded-lg py-2.5 pl-3.5 pr-8 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer"
                >
            ...
            {/* 2. Text Input with Attached Modern Search Button */}
            <div className="flex-1 flex items-stretch">
              <div className="relative flex-1">
                <input
                  type="text"
                  placeholder={`Search scholars by ${selectedField.toLowerCase()} (e.g. ${
                    selectedField === "Name"
                      ? "Aarav"
                      : selectedField === "SR No"
                      ? "SR-2024-001"
                  ...
                  className="w-full h-full border border-r-0 border-slate-300 rounded-l-lg px-3.5 py-2 text-xs sm:text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                />
                {searchQuery && (
                  <button
                    type="button"
              ...
              {/* Modern Attached Search Button */}
              <button
                type="submit"
                className="px-5 py-2.5 font-semibold text-xs text-white bg-emerald-600 hover:bg-emerald-500 rounded-r-lg transition-colors flex items-center space-x-1.5 shadow-xs"
              >
            ...
            <button
              ...
              className={`px-4 py-2.5 border rounded-lg text-xs font-semibold flex items-center justify-center space-x-1.5 transition-all ${
                isAdvanceOpen
          ...
          {/* ADVANCE SEARCH SLIDE-DOWN FILTER DRAWER */}
          {isAdvanceOpen && (
            <div className="pt-4 mt-3 border-t border-slate-200 animate-fadeIn space-y-3 bg-slate-50/70 p-4 rounded-xl">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2 border border-slate-300 rounded-lg bg-white text-slate-800 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  >
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 px-1">
          <div className="flex items-center space-x-2 text-xs">
            ...
            {activeQuery && (
              <span className="px-2 py-0.5 bg-emerald-50 text-emerald-700 font-semibold rounded-md border border-emerald-200 text-[11px]">
        ...
        <div className="bg-white rounded-xl shadow-xs border border-slate-200/80 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse text-xs">
              <thead className="bg-slate-900 text-slate-200 font-semibold border-b border-slate-800 uppercase tracking-wider text-[10px]">
                <tr>
                  <th className="py-3 px-4 w-14 text-center">Scholar</th>
                  <th className="py-3 px-4">Student Name & Identifiers</th>
                  <th className="py-3 px-4">Class & Section</th>
                  <th className="py-3 px-4">Guardian Details</th>
                  <th className="py-3 px-4">Contact & SMS</th>
                ...
                {filteredStudents.length > 0 ? (
                  filteredStudents.map((student) => {
                    ...
                    return (
                      ...
                      >
                        {/* Authentic Monogram Avatar Badge */}
                        <td className="py-3.5 px-4 text-center">
                          <div className="w-9 h-9 rounded-full bg-slate-100 text-slate-700 font-bold text-xs flex items-center justify-center border border-slate-200/80 mx-auto shadow-2xs group-hover:border-emerald-500 group-hover:bg-emerald-50 group-hover:text-emerald-800 transition-all">
                            {initials}
                          </div>
                        </td>
                        ...
                        {/* Class - Sec */}
                        <td className="py-3.5 px-4">
                          <span className="inline-block px-2.5 py-1 rounded-md bg-slate-100 text-slate-800 font-semibold font-mono text-[11px]">
                            {student.classSec}
                          </span>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <div className="flex items-center justify-center space-x-1.5">
                            ...
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold flex items-center space-x-1 transition-colors"
                  ...
                  <tr>
                    <td colSpan={6} className="py-12 text-center text-slate-400 space-y-2">
                      ...
                      <button
                        onClick={handleResetFilters}
                        className="px-3.5 py-2 bg-emerald-600 text-white rounded-lg text-xs font-semibold inline-block mt-2 shadow-xs hover:bg-emerald-500"
                      >
